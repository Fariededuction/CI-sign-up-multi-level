          ...
          <div class="row justify-content-center">
            <div class="col-lg-3 header-sign-in ">
              ...
              <div class="row">
                <div>
                  <p class="title-form">
                    Anda Harus register jika belum punya akun</a>

                  </p>
                  <?= $this->session->flashdata('message'); ?>

                  <p class="title-form">
                    captcha harus betul</a>
                ...
                <form action="<?= base_url('login/kirim')?>" method="post" >
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" name="password" class="form-control form-control input-type-primary-tikersaya"
                      ...
                      <div class="form-group">
                        ...
                        <a href="#" onclick="parent.window.location.reload(true)">[acak gambar lagi]</a>
                        <br>
                        <input type = "text" name = "captcha" class= "form-control" placeholder="Ketik Captcha" required>
