...
$db['PAJAKDAERAH']['pconnect'] = TRUE;
$db['PAJAKDAERAH']['db_debug'] = TRUE;
$db['PAJAKDAERAH']['cache_on'] = FALSE;
$db['PAJAKDAERAH']['cachedir'] = '';
$db['PAJAKDAERAH']['char_set'] = 'utf8';
$db['PAJAKDAERAH']['dbcollat'] = 'utf8_general_ci';
$db['PAJAKDAERAH']['swap_pre'] = '';
$db['PAJAKDAERAH']['autoinit'] = TRUE;
$db['PAJAKDAERAH']['stricton'] = FALSE;
